...
public class AttentionDialog {
    public static AlertDialog create(final Activity activity, @NonNull String message, DialogInterface.OnClickListener onDeleteAction) {
    ...
    public static AlertDialog createDeleteDialog(final Activity activity, DialogInterface.OnClickListener onDeleteAction) {
        final AlertDialog alertDialog = new AlertDialog.Builder(activity)
